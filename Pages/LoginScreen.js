...
import {View,Text,TextInput,TouchableOpacity,ImageBackground,SafeAreaView,KeyboardAvoidingView,ScrollView,Platform,
} from 'react-native';
            ...
            <View className="rounded-xl min-h-[300px] justify-center">
              ...
              <View className="mt-8 flex-row bg-[#7676801F] rounded-lg mb-5 mx-2 p-1">
                ...
                >
                  <Text
                    className={`text-lg font-bold ${
                      mode === 'register' ? 'text-black' : 'text-black'
                    }`}
                  >
                    Registre-se
                  </Text>
                ...
                >
                  <Text
                    className={`text-lg font-bold ${
                      mode === 'login' ? 'text-black' : 'text-black'
                    }`}
                  >
                    Login
                  </Text>
